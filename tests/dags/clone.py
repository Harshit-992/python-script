...
#                      python3 ck_auto_demo_emr/main.py --year 2023 --month 10 --app ck-auto-demo --env prod --build_number 91 --flow terminate-cluster --template payer --payer '674600239845,741843927392' --core_node_spot_percent 80
...
master_refresh = BashOperator(
    ...
    bash_command=f"""pwd
                     ...
                     python3 ck_auto_emr_demo/main.py --year 2023 --month 10 --env 'prod' --payer '674600239845,741843927392' --build_number '91'
